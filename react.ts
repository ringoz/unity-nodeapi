...
export interface VisualElement {
  ...
  onPreviewFocus: Action<RoutedEvent>;
  onFocusOut: Action<RoutedEvent>;
  onPreviewFocusOut: Action<RoutedEvent>;
  onFocusIn: Action<RoutedEvent>;
  onPreviewFocusIn: Action<RoutedEvent>;
  onChangeBoolean: Action<ChangeEvent>;
  onPreviewChangeBoolean: Action<ChangeEvent>;
  onChangeInt32: Action<ChangeEvent>;
  onPreviewChangeInt32: Action<ChangeEvent>;
  onChangeSingle: Action<ChangeEvent>;
  onPreviewChangeSingle: Action<ChangeEvent>;
  onChangeString: Action<ChangeEvent>;
  onPreviewChangeString: Action<ChangeEvent>;
  onChangeRect: Action<ChangeEvent>;
  onPreviewChangeRect: Action<ChangeEvent>;
  ...
  onPreviewKeyUp: Action<KeyboardEvent>;
  onClick: Action<PointerEvent>;
  onPreviewClick: Action<PointerEvent>;
  onWheel: Action<PointerEvent>;
  onPreviewWheel: Action<PointerEvent>;
  onPointerCapture: Action<PointerEvent>;
  onPreviewPointerCapture: Action<PointerEvent>;
  onPointerCaptureOut: Action<PointerEvent>;
  onPreviewPointerCaptureOut: Action<PointerEvent>;
  onPointerDown: Action<PointerEvent>;
  onPreviewPointerDown: Action<PointerEvent>;
  onPointerUp: Action<PointerEvent>;
  onPreviewPointerUp: Action<PointerEvent>;
  onPointerMove: Action<PointerEvent>;
  onPreviewPointerMove: Action<PointerEvent>;
  onPointerEnter: Action<PointerEvent>;
  onPreviewPointerEnter: Action<PointerEvent>;
  onPointerLeave: Action<PointerEvent>;
  onPreviewPointerLeave: Action<PointerEvent>;
  onPointerOver: Action<PointerEvent>;
  onPreviewPointerOver: Action<PointerEvent>;
  onPointerOut: Action<PointerEvent>;
  onPreviewPointerOut: Action<PointerEvent>;
  onPointerCancel: Action<PointerEvent>;
  onPreviewPointerCancel: Action<PointerEvent>;
  onNavigationMove: Action<NavigationEvent>;
  onPreviewNavigationMove: Action<NavigationEvent>;
  onNavigationCancel: Action<NavigationEvent>;
  onPreviewNavigationCancel: Action<NavigationEvent>;
  onNavigationSubmit: Action<NavigationEvent>;
  onPreviewNavigationSubmit: Action<NavigationEvent>;
}
